...
Of the 61 finished: **22 independently verified**, 39 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.

### By phase

| Phase | Done | Review | Doing | Left | Settled |
|---|---|---|---|---|---|
| Phase U · UI first  ◀ NEXT | 1/36 | 23 | 7 | 30d | `▓▓▓▓▓▓▓░░░` 67% |
| Phase −1 · Pilot | 0/13 | 0 | 0 | 36d | `░░░░░░░░░░` 0% |
| Phase 0 · Foundations | 20/124 | 13 | 25 | 259d | `██▓░░░░░░░` 27% |
| Phase 1 · Indonesia MVP | 1/92 | 3 | 17 | 335d | `░░░░░░░░░░` 4% |
| Phase 2 · Depth | 0/22 | 0 | 0 | 240d | `░░░░░░░░░░` 0% |
| Phase 3 · Marketplace & AU | 0/6 | 0 | 0 | 112d | `░░░░░░░░░░` 0% |

- **Phase U · UI first  ◀ NEXT** — **24 of 36 settled** (1 verified · 23 awaiting a verifier) · 7 in progress · **30d** left · **nothing ready to start now** · 2 more once in-flight dependencies land · 2 blocked outside the graph. Widest gate: **YT-0400** `web` `review` — **28** open tasks downstream.
...
- **Phase 0 · Foundations** — **33 of 124 settled** (20 verified · 13 awaiting a verifier) · 25 in progress · **259d** left · **30 ready to start** · 14 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0041** `value` `review` — **85** open tasks downstream.
- **Phase 1 · Indonesia MVP** — **4 of 92 settled** (1 verified · 3 awaiting a verifier) · 17 in progress · **335d** left · **3 ready to start** · 16 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0100** `adplatform` `doing` — **63** open tasks downstream.
...
- `adplatform` — **1 of 17 settled** (0 verified · 1 awaiting a verifier) · 1 in progress · **93d** left · **nothing ready to start now** · 4 more once in-flight dependencies land. Widest gate: **YT-0100** `adplatform` `doing` — **63** open tasks downstream.
...
- `platform` — **21 of 54 settled** (13 verified · 8 awaiting a verifier) · 8 in progress · **103d** left · **12 ready to start** · 6 more once in-flight dependencies land. Widest gate: **YT-0039** `platform` `doing` — **75** open tasks downstream.
...
- `value` — **5 of 27 settled** (0 verified · 5 awaiting a verifier) · 7 in progress · **101d** left · **nothing ready to start now** · 8 more once in-flight dependencies land. Widest gate: **YT-0041** `value` `review` — **85** open tasks downstream.
...
- `web` — **22 of 58 settled** (1 verified · 21 awaiting a verifier) · 14 in progress · **131d** left · **1 ready to start** · 4 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0400** `web` `review` — **28** open tasks downstream.
