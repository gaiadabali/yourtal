...
**293 tasks** — **61 finished (21%)** · 49 in progress · 178 not started · 5 blocked

**1011 engineer-days left of 1190** — **15% of the estimated effort is settled**, against 21% of the task count. Effort counts every `todo`, `doing` and `blocked` task at its FULL estimate, so a half-finished task bills in full. These are ideal engineer-days for one person — divide by real throughput, not by headcount.

Of the 61 finished: **15 independently verified**, 46 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.

### By phase

| Phase | Done | Review | Doing | Left | Settled |
|---|---|---|---|---|---|
| Phase U · UI first  ◀ NEXT | 0/36 | 24 | 7 | 30d | `▓▓▓▓▓▓▓░░░` 67% |
| Phase −1 · Pilot | 0/13 | 0 | 0 | 36d | `░░░░░░░░░░` 0% |
| Phase 0 · Foundations | 14/124 | 19 | 25 | 259d | `█▓▓░░░░░░░` 27% |
| Phase 1 · Indonesia MVP | 1/92 | 3 | 17 | 335d | `░░░░░░░░░░` 4% |
| Phase 2 · Depth | 0/22 | 0 | 0 | 240d | `░░░░░░░░░░` 0% |
| Phase 3 · Marketplace & AU | 0/6 | 0 | 0 | 112d | `░░░░░░░░░░` 0% |

- **Phase U · UI first  ◀ NEXT** — **24 of 36 settled** (0 verified · 24 awaiting a verifier) · 7 in progress · **30d** left · **nothing ready to start now** · 2 more once in-flight dependencies land · 2 blocked outside the graph. Widest gate: **YT-0400** `web` `review` — **28** open tasks downstream.
...
- **Phase 0 · Foundations** — **33 of 124 settled** (14 verified · 19 awaiting a verifier) · 25 in progress · **259d** left · **29 ready to start** · 15 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0041** `value` `review` — **86** open tasks downstream.
- **Phase 1 · Indonesia MVP** — **4 of 92 settled** (1 verified · 3 awaiting a verifier) · 17 in progress · **335d** left · **2 ready to start** · 17 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0100** `adplatform` `doing` — **64** open tasks downstream.
...
| `economy` | 0/8 | 0 | 3 | **1** +1 | 31d | `░░░░░░░░░░` 0% |
| `infra` | 5/31 | 1 | 3 | **11** +3 | 86d | `██░░░░░░░░` 19% |
| `legal` | 1/9 | 0 | 0 | **4** | 32d | `█░░░░░░░░░` 11% |
| `media` | 0/13 | 1 | 1 | **1** | 67d | `▓░░░░░░░░░` 8% |
| `merchant` | 0/17 | 2 | 5 | — +7 | 66d | `▓░░░░░░░░░` 12% |
| `pilot` | 0/11 | 0 | 0 | **1** | 29d | `░░░░░░░░░░` 0% |
| `platform` | 8/54 | 13 | 8 | **11** +7 | 103d | `██▓▓░░░░░░` 39% |
| `risk` | 0/15 | 0 | 0 | **4** +1 | 69d | `░░░░░░░░░░` 0% |
| `seo` | 0/5 | 1 | 2 | — +1 | 15d | `▓▓░░░░░░░░` 20% |
| `store` | 0/10 | 0 | 3 | — +1 | 92d | `░░░░░░░░░░` 0% |
| `value` | 0/27 | 5 | 7 | — +8 | 101d | `▓▓░░░░░░░░` 19% |
...
- `adplatform` — **1 of 17 settled** (0 verified · 1 awaiting a verifier) · 1 in progress · **93d** left · **nothing ready to start now** · 4 more once in-flight dependencies land. Widest gate: **YT-0100** `adplatform` `doing` — **64** open tasks downstream.
- `commerce` — **0 of 1 settled** (0 verified · 0 awaiting a verifier) · 0 in progress · **20d** left · **nothing ready to start now**.
- `data` — **0 of 9 settled** (0 verified · 0 awaiting a verifier) · 1 in progress · **47d** left · **2 ready to start** · 1 more once in-flight dependencies land. Widest gate: **YT-0519** `data` `doing` — **14** open tasks downstream.
- `economy` — **0 of 8 settled** (0 verified · 0 awaiting a verifier) · 3 in progress · **31d** left · **1 ready to start** · 1 more once in-flight dependencies land. Widest gate: **YT-0048** `economy` `todo` — **25** open tasks downstream.
- `infra` — **6 of 31 settled** (5 verified · 1 awaiting a verifier) · 3 in progress · **86d** left · **11 ready to start** · 3 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **46** open tasks downstream.
- `legal` — **1 of 9 settled** (1 verified · 0 awaiting a verifier) · 0 in progress · **32d** left · **4 ready to start** · 2 blocked outside the graph. Widest gate: **YT-0012** `legal` `todo` — **28** open tasks downstream.
...
- `merchant` — **2 of 17 settled** (0 verified · 2 awaiting a verifier) · 5 in progress · **66d** left · **nothing ready to start now** · 7 more once in-flight dependencies land. Widest gate: **YT-0150** `merchant` `doing` — **18** open tasks downstream.
...
- `platform` — **21 of 54 settled** (8 verified · 13 awaiting a verifier) · 8 in progress · **103d** left · **11 ready to start** · 7 more once in-flight dependencies land. Widest gate: **YT-0039** `platform` `doing` — **75** open tasks downstream.
- `risk` — **0 of 15 settled** (0 verified · 0 awaiting a verifier) · 0 in progress · **69d** left · **4 ready to start** · 1 more once in-flight dependencies land. Widest gate: **YT-0051** `risk` `todo` — **10** open tasks downstream.
- `seo` — **1 of 5 settled** (0 verified · 1 awaiting a verifier) · 2 in progress · **15d** left · **nothing ready to start now** · 1 more once in-flight dependencies land. Widest gate: **YT-0180** `seo` `review` — **8** open tasks downstream.
- `store` — **0 of 10 settled** (0 verified · 0 awaiting a verifier) · 3 in progress · **92d** left · **nothing ready to start now** · 1 more once in-flight dependencies land. Widest gate: **YT-0130** `store` `doing` — **22** open tasks downstream.
- `value` — **5 of 27 settled** (0 verified · 5 awaiting a verifier) · 7 in progress · **101d** left · **nothing ready to start now** · 8 more once in-flight dependencies land. Widest gate: **YT-0041** `value` `review` — **86** open tasks downstream.
...
- `web` — **22 of 58 settled** (0 verified · 22 awaiting a verifier) · 14 in progress · **131d** left · **nothing ready to start now** · 5 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0400** `web` `review` — **28** open tasks downstream.
...
- **YT-0012** `legal` Counsel-substitution risk acceptance · 1d
...
- **YT-0559** Contract entries for the campaign, watch and health routes → waiting on YT-0553, YT-0556
...
- **YT-0564** The result screen says "Total received" for a number nobody has granted → waiting on YT-0561
