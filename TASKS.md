...
Of the 78 finished: **47 independently verified**, 31 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.
...
| Phase 0 · Foundations | 29/128 | 12 | 23 | 251d | `██▓░░░░░░░` 32% |
...
- **Phase 0 · Foundations** — **41 of 128 settled** (29 verified · 12 awaiting a verifier) · 23 in progress · **251d** left · **32 ready to start** · 16 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **45** open tasks downstream.
...
- `value` — **6 of 27 settled** (3 verified · 3 awaiting a verifier) · 6 in progress · **99d** left · **1 ready to start** · 7 more once in-flight dependencies land. Widest gate: **YT-0142** `value` `doing` — **30** open tasks downstream.
