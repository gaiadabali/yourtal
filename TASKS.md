...
**297 tasks** — **79 finished (27%)** · 39 in progress · 175 not started · 4 blocked

**980 engineer-days left of 1198** — **18% of the estimated effort is settled**, against 27% of the task count. Effort counts every `todo`, `doing` and `blocked` task at its FULL estimate, so a half-finished task bills in full. These are ideal engineer-days for one person — divide by real throughput, not by headcount.

Of the 79 finished: **50 independently verified**, 29 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.

### By phase

| Phase | Done | Review | Doing | Left | Settled |
|---|---|---|---|---|---|
| Phase U · UI first  ◀ NEXT | 15/36 | 13 | 3 | 21d | `████▓▓▓▓░░` 78% |
| Phase −1 · Pilot | 0/13 | 0 | 0 | 36d | `░░░░░░░░░░` 0% |
| Phase 0 · Foundations | 29/128 | 13 | 22 | 251d | `██▓░░░░░░░` 33% |
| Phase 1 · Indonesia MVP | 6/92 | 3 | 14 | 320d | `█░░░░░░░░░` 10% |
| Phase 2 · Depth | 0/22 | 0 | 0 | 240d | `░░░░░░░░░░` 0% |
| Phase 3 · Marketplace & AU | 0/6 | 0 | 0 | 112d | `░░░░░░░░░░` 0% |

- **Phase U · UI first  ◀ NEXT** — **28 of 36 settled** (15 verified · 13 awaiting a verifier) · 3 in progress · **21d** left · **nothing ready to start now** · 2 more once in-flight dependencies land · 2 blocked outside the graph. Widest gate: **YT-0410** `web` `review` — **7** open tasks downstream.
...
- **Phase 0 · Foundations** — **42 of 128 settled** (29 verified · 13 awaiting a verifier) · 22 in progress · **251d** left · **32 ready to start** · 16 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **45** open tasks downstream.
- **Phase 1 · Indonesia MVP** — **9 of 92 settled** (6 verified · 3 awaiting a verifier) · 14 in progress · **320d** left · **5 ready to start** · 13 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0100** `adplatform` `doing` — **68** open tasks downstream.
...
| `value` | 3/27 | 4 | 5 | **1** +7 | 99d | `█▓▓░░░░░░░` 26% |
| `watch` | 2/8 | 1 | 0 | — +1 | 22d | `███▓░░░░░░` 38% |
| `web` | 13/59 | 14 | 9 | **1** +5 | 127d | `██▓▓▓░░░░░` 46% |
...
- `value` — **7 of 27 settled** (3 verified · 4 awaiting a verifier) · 5 in progress · **99d** left · **1 ready to start** · 7 more once in-flight dependencies land. Widest gate: **YT-0142** `value` `doing` — **30** open tasks downstream.
...
- `web` — **27 of 59 settled** (13 verified · 14 awaiting a verifier) · 9 in progress · **127d** left · **1 ready to start** · 5 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0055** `web` `doing` — **26** open tasks downstream.
