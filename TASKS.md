...
**300 tasks** — **81 finished (27%)** · 43 in progress · 172 not started · 4 blocked

**974 engineer-days left of 1200** — **19% of the estimated effort is settled**, against 27% of the task count. Effort counts every `todo`, `doing` and `blocked` task at its FULL estimate, so a half-finished task bills in full. These are ideal engineer-days for one person — divide by real throughput, not by headcount.
...
| Phase 0 · Foundations | 40/131 | 3 | 23 | 250d | `███░░░░░░░` 33% |
...
- **Phase 0 · Foundations** — **43 of 131 settled** (40 verified · 3 awaiting a verifier) · 23 in progress · **250d** left · **41 ready to start** · 9 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **45** open tasks downstream.
...
- `web` — **27 of 62 settled** (25 verified · 2 awaiting a verifier) · 11 in progress · **129d** left · **6 ready to start** · 2 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0055** `web` `doing` — **26** open tasks downstream.
...
- **YT-0525** Migrate hand-built forms to React Hook Form — 3/5 AC
