...
**273 tasks** — **43 finished (16%)** · 56 in progress · 168 not started · 6 blocked

Of the 43 finished: **0 independently verified**, 43 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.
...
| Phase 0 · Foundations | 0/108 | 20 | 31 | `▓▓░░░░░░░░` 19% |
| Phase 1 · Indonesia MVP | 0/90 | 2 | 15 | `░░░░░░░░░░` 2% |
