...
**273 tasks** — **41 finished (15%)** · 58 in progress · 168 not started · 6 blocked

Of the 41 finished: **0 independently verified**, 41 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.
...
| Phase 0 · Foundations | 0/108 | 19 | 32 | `▓▓░░░░░░░░` 18% |
