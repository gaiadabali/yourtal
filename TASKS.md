...
**290 tasks** — **61 finished (21%)** · 48 in progress · 176 not started · 5 blocked

**1007 engineer-days left of 1186** — **15% of the estimated effort is settled**, against 21% of the task count. Effort counts every `todo`, `doing` and `blocked` task at its FULL estimate, so a half-finished task bills in full. These are ideal engineer-days for one person — divide by real throughput, not by headcount.
...
| Phase 0 · Foundations | 4/122 | 29 | 24 | 257d | `▓▓▓░░░░░░░` 27% |
...
- **Phase 0 · Foundations** — **33 of 122 settled** (4 verified · 29 awaiting a verifier) · 24 in progress · **257d** left · **25 ready to start** · 18 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0041** `value` `review` — **88** open tasks downstream.
- **Phase 1 · Indonesia MVP** — **4 of 92 settled** (1 verified · 3 awaiting a verifier) · 17 in progress · **335d** left · **2 ready to start** · 17 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0100** `adplatform` `doing` — **63** open tasks downstream.
...
| `platform` | 2/52 | 19 | 7 | **8** +9 | 101d | `▓▓▓▓░░░░░░` 40% |
...
- `platform` — **21 of 52 settled** (2 verified · 19 awaiting a verifier) · 7 in progress · **101d** left · **8 ready to start** · 9 more once in-flight dependencies land. Widest gate: **YT-0039** `platform` `doing` — **75** open tasks downstream.
