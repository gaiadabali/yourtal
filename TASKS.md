...
**295 tasks** — **74 finished (25%)** · 41 in progress · 175 not started · 5 blocked
...
| Phase 0 · Foundations | 24/126 | 16 | 22 | 250d | `██▓░░░░░░░` 32% |
...
- **Phase 0 · Foundations** — **40 of 126 settled** (24 verified · 16 awaiting a verifier) · 22 in progress · **250d** left · **28 ready to start** · 19 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0039** `platform` `review` — **81** open tasks downstream.
