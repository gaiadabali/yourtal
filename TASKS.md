...
**303 tasks** — **81 finished (27%)** · 44 in progress · 174 not started · 4 blocked

**979 engineer-days left of 1205** — **19% of the estimated effort is settled**, against 27% of the task count. Effort counts every `todo`, `doing` and `blocked` task at its FULL estimate, so a half-finished task bills in full. These are ideal engineer-days for one person — divide by real throughput, not by headcount.
...
| Phase 0 · Foundations | 43/134 | 0 | 24 | 254d | `███░░░░░░░` 32% |
...
- **Phase 0 · Foundations** — **43 of 134 settled** (43 verified · 0 awaiting a verifier) · 24 in progress · **254d** left · **43 ready to start** · 10 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **45** open tasks downstream.
