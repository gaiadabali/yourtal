...
Of the 61 finished: **25 independently verified**, 36 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.

### By phase

| Phase | Done | Review | Doing | Left | Settled |
|---|---|---|---|---|---|
| Phase U · UI first  ◀ NEXT | 4/36 | 20 | 7 | 30d | `█▓▓▓▓▓▓░░░` 67% |
...
- **Phase U · UI first  ◀ NEXT** — **24 of 36 settled** (4 verified · 20 awaiting a verifier) · 7 in progress · **30d** left · **nothing ready to start now** · 2 more once in-flight dependencies land · 2 blocked outside the graph. Widest gate: **YT-0400** `web` `review` — **25** open tasks downstream.
...
- `web` — **22 of 58 settled** (4 verified · 18 awaiting a verifier) · 14 in progress · **131d** left · **1 ready to start** · 4 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0055** `web` `doing` — **27** open tasks downstream.
