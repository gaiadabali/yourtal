...
**297 tasks** — **78 finished (26%)** · 41 in progress · 174 not started · 4 blocked
...
Of the 78 finished: **71 independently verified**, 7 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.

### By phase

| Phase | Done | Review | Doing | Left | Settled |
|---|---|---|---|---|---|
| Phase U · UI first  ◀ NEXT | 25/36 | 2 | 4 | 22d | `███████▓░░` 75% |
...
- **Phase U · UI first  ◀ NEXT** — **27 of 36 settled** (25 verified · 2 awaiting a verifier) · 4 in progress · **22d** left · **2 ready to start** · 2 blocked outside the graph. Widest gate: **YT-0412** `web` `review` — **3** open tasks downstream.
...
- `web` — **26 of 59 settled** (24 verified · 2 awaiting a verifier) · 10 in progress · **128d** left · **3 ready to start** · 3 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0055** `web` `doing` — **26** open tasks downstream.
