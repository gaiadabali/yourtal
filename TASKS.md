...
**301 tasks** — **81 finished (27%)** · 44 in progress · 172 not started · 4 blocked
...
| Phase 0 · Foundations | 40/132 | 3 | 24 | 252d | `███░░░░░░░` 33% |
...
- **Phase 0 · Foundations** — **43 of 132 settled** (40 verified · 3 awaiting a verifier) · 24 in progress · **252d** left · **41 ready to start** · 10 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **45** open tasks downstream.
...
| `platform` | 25/55 | 2 | 7 | **12** +4 | 89d | `█████░░░░░` 49% |
...
- `platform` — **27 of 55 settled** (25 verified · 2 awaiting a verifier) · 7 in progress · **89d** left · **12 ready to start** · 4 more once in-flight dependencies land. Widest gate: **YT-0040** `platform` `review` — **18** open tasks downstream.
