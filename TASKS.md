...
**304 tasks** — **83 finished (27%)** · 45 in progress · 172 not started · 4 blocked
...
| Phase 0 · Foundations | 44/135 | 0 | 24 | 255d | `███░░░░░░░` 33% |
...
- **Phase 0 · Foundations** — **44 of 135 settled** (44 verified · 0 awaiting a verifier) · 24 in progress · **255d** left · **44 ready to start** · 9 more once in-flight dependencies land. Widest gate: **YT-0055** `web` `doing` — **21** open tasks downstream.
