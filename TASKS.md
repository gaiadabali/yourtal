...
**273 tasks** — **42 finished (15%)** · 57 in progress · 168 not started · 6 blocked

Of the 42 finished: **0 independently verified**, 42 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.
