...
**294 tasks** — **68 finished (23%)** · 47 in progress · 174 not started · 5 blocked

**988 engineer-days left of 1190** — **17% of the estimated effort is settled**, against 23% of the task count. Effort counts every `todo`, `doing` and `blocked` task at its FULL estimate, so a half-finished task bills in full. These are ideal engineer-days for one person — divide by real throughput, not by headcount.

Of the 68 finished: **41 independently verified**, 27 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.
...
| Phase 0 · Foundations | 24/125 | 12 | 26 | 252d | `██▓░░░░░░░` 29% |
| Phase 1 · Indonesia MVP | 4/92 | 2 | 16 | 326d | `▓░░░░░░░░░` 7% |
...
- **Phase 0 · Foundations** — **36 of 125 settled** (24 verified · 12 awaiting a verifier) · 26 in progress · **252d** left · **28 ready to start** · 18 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0039** `platform` `doing` — **73** open tasks downstream.
- **Phase 1 · Indonesia MVP** — **6 of 92 settled** (4 verified · 2 awaiting a verifier) · 16 in progress · **326d** left · **5 ready to start** · 14 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0100** `adplatform` `doing` — **61** open tasks downstream.
...
| `platform` | 15/54 | 7 | 9 | **10** +7 | 99d | `███▓░░░░░░` 41% |
...
- `platform` — **22 of 54 settled** (15 verified · 7 awaiting a verifier) · 9 in progress · **99d** left · **10 ready to start** · 7 more once in-flight dependencies land. Widest gate: **YT-0039** `platform` `doing` — **73** open tasks downstream.
