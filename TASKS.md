...
| ⚠️ **YT-0506 — the tracker said sen, the code says Rupiah** | Reconciled against the working tree 2026-09-19. This entry had claimed, ticked, that sen was implemented; **`rupiahToSen` does not exist anywhere in the repo**, and `money.test.ts` carries a *passing* guard named _"stores IDR as Rupiah, not sen, until YT-0506 settles"_. Two sen-flavoured comments stranded on Rupiah data have been corrected — one said _"do NOT `toIdrMinorUnits` it"_ directly above a line that does. **The decision itself is still yours**, and the driver seam (YT-0537) means it no longer gates the ledger. |
...
**0 / 243 tasks done (0%)** · 57 in review · 3 in progress · 2 blocked

### By phase

| Phase | Done | Review | Doing | Settled |
|---|---|---|---|---|
| Phase U · UI first  ◀ NEXT | 0/31 | 27 | 0 | `▓▓▓▓▓▓▓▓▓░` 87% |
| Phase −1 · Pilot | 0/13 | 0 | 0 | `░░░░░░░░░░` 0% |
| Phase 0 · Foundations | 0/89 | 29 | 3 | `▓▓▓░░░░░░░` 33% |
| Phase 1 · Indonesia MVP | 0/84 | 1 | 0 | `░░░░░░░░░░` 1% |
| Phase 2 · Depth | 0/20 | 0 | 0 | `░░░░░░░░░░` 0% |
...
- **YT-0521** `media` Local object storage and media origin — 4/5 AC ticked
...
- **YT-0525** `web` Migrate hand-built forms to React Hook Form · 2d
...
- **YT-0535** One driver interface per external boundary → waiting on YT-0031
- **YT-0536** Simulators that can fail → waiting on YT-0535
