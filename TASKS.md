...
**297 tasks** — **78 finished (26%)** · 40 in progress · 175 not started · 4 blocked

**980 engineer-days left of 1198** — **18% of the estimated effort is settled**, against 26% of the task count. Effort counts every `todo`, `doing` and `blocked` task at its FULL estimate, so a half-finished task bills in full. These are ideal engineer-days for one person — divide by real throughput, not by headcount.

Of the 78 finished: **60 independently verified**, 18 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.

### By phase

| Phase | Done | Review | Doing | Left | Settled |
|---|---|---|---|---|---|
| Phase U · UI first  ◀ NEXT | 15/36 | 12 | 4 | 22d | `████▓▓▓▓░░` 75% |
| Phase −1 · Pilot | 0/13 | 0 | 0 | 36d | `░░░░░░░░░░` 0% |
| Phase 0 · Foundations | 39/128 | 4 | 22 | 248d | `███░░░░░░░` 34% |
| Phase 1 · Indonesia MVP | 6/92 | 2 | 14 | 322d | `█░░░░░░░░░` 9% |
| Phase 2 · Depth | 0/22 | 0 | 0 | 240d | `░░░░░░░░░░` 0% |
| Phase 3 · Marketplace & AU | 0/6 | 0 | 0 | 112d | `░░░░░░░░░░` 0% |

- **Phase U · UI first  ◀ NEXT** — **27 of 36 settled** (15 verified · 12 awaiting a verifier) · 4 in progress · **22d** left · **1 ready to start** · 1 more once in-flight dependencies land · 2 blocked outside the graph. Widest gate: **YT-0410** `web` `review` — **7** open tasks downstream.
- **Phase −1 · Pilot** — **0 of 13 settled** (0 verified · 0 awaiting a verifier) · 0 in progress · **36d** left · **4 ready to start**. Widest gate: **YT-0220** `media` `todo` — **27** open tasks downstream.
- **Phase 0 · Foundations** — **43 of 128 settled** (39 verified · 4 awaiting a verifier) · 22 in progress · **248d** left · **37 ready to start** · 11 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **45** open tasks downstream.
- **Phase 1 · Indonesia MVP** — **8 of 92 settled** (6 verified · 2 awaiting a verifier) · 14 in progress · **322d** left · **6 ready to start** · 13 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0100** `adplatform` `doing` — **67** open tasks downstream.
...
- `adplatform` — **1 of 17 settled** (1 verified · 0 awaiting a verifier) · 1 in progress · **93d** left · **3 ready to start** · 1 more once in-flight dependencies land. Widest gate: **YT-0100** `adplatform` `doing` — **67** open tasks downstream.
- `commerce` — **0 of 1 settled** (0 verified · 0 awaiting a verifier) · 0 in progress · **20d** left · **nothing ready to start now**.
- `data` — **0 of 9 settled** (0 verified · 0 awaiting a verifier) · 1 in progress · **47d** left · **2 ready to start** · 2 more once in-flight dependencies land. Widest gate: **YT-0519** `data` `doing` — **13** open tasks downstream.
- `economy` — **2 of 8 settled** (2 verified · 0 awaiting a verifier) · 2 in progress · **28d** left · **1 ready to start** · 2 more once in-flight dependencies land. Widest gate: **YT-0048** `economy` `doing` — **24** open tasks downstream.
- `infra` — **6 of 32 settled** (6 verified · 0 awaiting a verifier) · 3 in progress · **86d** left · **13 ready to start** · 2 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **45** open tasks downstream.
...
- `media` — **1 of 13 settled** (1 verified · 0 awaiting a verifier) · 1 in progress · **67d** left · **1 ready to start**. Widest gate: **YT-0220** `media` `todo` — **27** open tasks downstream.
...
- `platform` — **26 of 55 settled** (25 verified · 1 awaiting a verifier) · 6 in progress · **90d** left · **14 ready to start** · 3 more once in-flight dependencies land. Widest gate: **YT-0040** `platform` `review` — **18** open tasks downstream.
...
- `value` — **7 of 27 settled** (5 verified · 2 awaiting a verifier) · 5 in progress · **99d** left · **2 ready to start** · 6 more once in-flight dependencies land. Widest gate: **YT-0142** `value` `doing` — **30** open tasks downstream.
...
- `web` — **26 of 59 settled** (13 verified · 13 awaiting a verifier) · 10 in progress · **128d** left · **3 ready to start** · 3 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0055** `web` `doing` — **26** open tasks downstream.

### In review (work complete, gate not yet passed)

- **YT-0040** `platform` Job queue and worker skeleton — 2/2 AC ticked
- **YT-0565** `value` The ledger schema-drift regex fails open — 8/8 AC ticked
...
- **YT-0584** `web` Replace the player’s local chapter fakes with the contract · 1d
...
- **YT-0049** Pricing engine → waiting on YT-0048
