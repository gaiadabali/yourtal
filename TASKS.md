...
| `platform` | 13/54 | 8 | 10 | **10** +7 | 103d | `██▓▓░░░░░░` 39% |
...
- `platform` — **21 of 54 settled** (13 verified · 8 awaiting a verifier) · 10 in progress · **103d** left · **10 ready to start** · 7 more once in-flight dependencies land. Widest gate: **YT-0039** `platform` `doing` — **75** open tasks downstream.
...
- **YT-0540** Email and password authentication — 0/4 AC
