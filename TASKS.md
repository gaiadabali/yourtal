...
Of the 61 finished: **5 independently verified**, 56 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.
...
| Phase 0 · Foundations | 4/124 | 29 | 25 | 259d | `▓▓▓░░░░░░░` 27% |
...
- **Phase 0 · Foundations** — **33 of 124 settled** (4 verified · 29 awaiting a verifier) · 25 in progress · **259d** left · **25 ready to start** · 19 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0041** `value` `review` — **88** open tasks downstream.
- **Phase 1 · Indonesia MVP** — **4 of 92 settled** (1 verified · 3 awaiting a verifier) · 17 in progress · **335d** left · **2 ready to start** · 17 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0100** `adplatform` `doing` — **65** open tasks downstream.
...
- `adplatform` — **1 of 17 settled** (0 verified · 1 awaiting a verifier) · 1 in progress · **93d** left · **nothing ready to start now** · 4 more once in-flight dependencies land. Widest gate: **YT-0100** `adplatform` `doing` — **65** open tasks downstream.
...
- `infra` — **6 of 31 settled** (1 verified · 5 awaiting a verifier) · 3 in progress · **86d** left · **10 ready to start** · 4 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **46** open tasks downstream.
...
- `platform` — **21 of 54 settled** (2 verified · 19 awaiting a verifier) · 8 in progress · **103d** left · **8 ready to start** · 10 more once in-flight dependencies land. Widest gate: **YT-0039** `platform` `doing` — **75** open tasks downstream.
...
- `value` — **5 of 27 settled** (0 verified · 5 awaiting a verifier) · 7 in progress · **101d** left · **nothing ready to start now** · 8 more once in-flight dependencies land. Widest gate: **YT-0041** `value` `review` — **88** open tasks downstream.
