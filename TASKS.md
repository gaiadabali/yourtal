...
Of the 79 finished: **52 independently verified**, 27 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.
...
| Phase 0 · Foundations | 31/128 | 11 | 22 | 251d | `██▓░░░░░░░` 33% |
...
- **Phase 0 · Foundations** — **42 of 128 settled** (31 verified · 11 awaiting a verifier) · 22 in progress · **251d** left · **34 ready to start** · 14 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **45** open tasks downstream.
...
| `platform` | 19/55 | 6 | 6 | **14** +4 | 93d | `████▓░░░░░` 45% |
| `risk` | 0/15 | 0 | 0 | **5** +1 | 69d | `░░░░░░░░░░` 0% |
| `seo` | 1/5 | 2 | 1 | — | 8d | `██▓▓▓▓░░░░` 60% |
| `store` | 0/10 | 0 | 3 | — +1 | 92d | `░░░░░░░░░░` 0% |
| `value` | 4/27 | 3 | 5 | **1** +7 | 99d | `██▓░░░░░░░` 26% |
...
- `platform` — **25 of 55 settled** (19 verified · 6 awaiting a verifier) · 6 in progress · **93d** left · **14 ready to start** · 4 more once in-flight dependencies land. Widest gate: **YT-0552** `platform` `doing` — **19** open tasks downstream.
...
- `value` — **7 of 27 settled** (4 verified · 3 awaiting a verifier) · 5 in progress · **99d** left · **1 ready to start** · 7 more once in-flight dependencies land. Widest gate: **YT-0142** `value` `doing` — **30** open tasks downstream.
...
- **YT-0541** `platform` Identity provider seam · 2d
- **YT-0542** `risk` Record what deferring phone verification costs · 1h
- _…and 19 more_
