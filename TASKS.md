...
**298 tasks** — **81 finished (27%)** · 42 in progress · 171 not started · 4 blocked

**973 engineer-days left of 1199** — **19% of the estimated effort is settled**, against 27% of the task count. Effort counts every `todo`, `doing` and `blocked` task at its FULL estimate, so a half-finished task bills in full. These are ideal engineer-days for one person — divide by real throughput, not by headcount.

Of the 81 finished: **73 independently verified**, 8 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.

### By phase

| Phase | Done | Review | Doing | Left | Settled |
|---|---|---|---|---|---|
| Phase U · UI first  ◀ NEXT | 26/36 | 2 | 5 | 21d | `███████▓░░` 78% |
| Phase −1 · Pilot | 0/13 | 0 | 0 | 36d | `░░░░░░░░░░` 0% |
| Phase 0 · Foundations | 40/129 | 3 | 22 | 249d | `███░░░░░░░` 33% |
| Phase 1 · Indonesia MVP | 7/92 | 3 | 15 | 316d | `█░░░░░░░░░` 11% |
| Phase 2 · Depth | 0/22 | 0 | 0 | 240d | `░░░░░░░░░░` 0% |
| Phase 3 · Marketplace & AU | 0/6 | 0 | 0 | 112d | `░░░░░░░░░░` 0% |

- **Phase U · UI first  ◀ NEXT** — **28 of 36 settled** (26 verified · 2 awaiting a verifier) · 5 in progress · **21d** left · **1 ready to start** · 2 blocked outside the graph. Widest gate: **YT-0450** `web` `blocked` — **1** open task downstream.
...
- **Phase 0 · Foundations** — **43 of 129 settled** (40 verified · 3 awaiting a verifier) · 22 in progress · **249d** left · **39 ready to start** · 10 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **45** open tasks downstream.
- **Phase 1 · Indonesia MVP** — **10 of 92 settled** (7 verified · 3 awaiting a verifier) · 15 in progress · **316d** left · **5 ready to start** · 14 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0100** `adplatform` `doing` — **66** open tasks downstream.
- **Phase 2 · Depth** — **0 of 22 settled** (0 verified · 0 awaiting a verifier) · 0 in progress · **240d** left · **2 ready to start** · 5 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0543** `data` `todo` — **3** open tasks downstream.
...
| `platform` | 25/55 | 2 | 6 | **13** +3 | 89d | `█████░░░░░` 49% |
| `risk` | 0/15 | 0 | 0 | **5** +1 | 69d | `░░░░░░░░░░` 0% |
| `seo` | 1/5 | 2 | 1 | — | 8d | `██▓▓▓▓░░░░` 60% |
| `store` | 0/10 | 0 | 3 | **1** +1 | 92d | `░░░░░░░░░░` 0% |
| `value` | 5/27 | 2 | 5 | **2** +6 | 99d | `██▓░░░░░░░` 26% |
| `watch` | 3/8 | 0 | 0 | **2** +1 | 19d | `████░░░░░░` 38% |
| `web` | 25/60 | 2 | 11 | **4** +2 | 128d | `████▓░░░░░` 45% |
...
- `adplatform` — **1 of 17 settled** (1 verified · 0 awaiting a verifier) · 1 in progress · **93d** left · **3 ready to start** · 1 more once in-flight dependencies land. Widest gate: **YT-0100** `adplatform` `doing` — **66** open tasks downstream.
- `commerce` — **0 of 1 settled** (0 verified · 0 awaiting a verifier) · 0 in progress · **20d** left · **nothing ready to start now**.
- `data` — **0 of 9 settled** (0 verified · 0 awaiting a verifier) · 2 in progress · **47d** left · **1 ready to start** · 3 more once in-flight dependencies land. Widest gate: **YT-0519** `data` `doing` — **13** open tasks downstream.
...
- `platform` — **27 of 55 settled** (25 verified · 2 awaiting a verifier) · 6 in progress · **89d** left · **13 ready to start** · 3 more once in-flight dependencies land. Widest gate: **YT-0040** `platform` `review` — **18** open tasks downstream.
...
- `watch` — **3 of 8 settled** (3 verified · 0 awaiting a verifier) · 0 in progress · **19d** left · **2 ready to start** · 1 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0123** `watch` `todo` — **8** open tasks downstream.
- `web` — **27 of 60 settled** (25 verified · 2 awaiting a verifier) · 11 in progress · **128d** left · **4 ready to start** · 2 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0055** `web` `doing` — **26** open tasks downstream.
...
- **YT-0581** `platform` `remove_member` never sends `targetRole`, so its PDP guard cannot fire — 2/2 AC ticked
- **YT-0043** `value` Chart of accounts — 7/7 AC ticked
- **YT-0526** `web` Testable HLS fixture for the player — 5/5 AC ticked
- **YT-0584** `web` Replace the player’s local chapter fakes with the contract — 1/1 AC ticked
