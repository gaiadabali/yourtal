...
**298 tasks** — **81 finished (27%)** · 43 in progress · 170 not started · 4 blocked
...
| Phase 0 · Foundations | 40/129 | 3 | 23 | 249d | `███░░░░░░░` 33% |
...
- **Phase 0 · Foundations** — **43 of 129 settled** (40 verified · 3 awaiting a verifier) · 23 in progress · **249d** left · **39 ready to start** · 9 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **45** open tasks downstream.
