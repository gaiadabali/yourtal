...
Of the 79 finished: **56 independently verified**, 23 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.
...
| Phase 0 · Foundations | 35/128 | 7 | 22 | 251d | `███░░░░░░░` 33% |
| Phase 1 · Indonesia MVP | 6/92 | 3 | 14 | 320d | `█░░░░░░░░░` 10% |
| Phase 2 · Depth | 0/22 | 0 | 0 | 240d | `░░░░░░░░░░` 0% |
| Phase 3 · Marketplace & AU | 0/6 | 0 | 0 | 112d | `░░░░░░░░░░` 0% |

- **Phase U · UI first  ◀ NEXT** — **28 of 36 settled** (15 verified · 13 awaiting a verifier) · 3 in progress · **21d** left · **1 ready to start** · 1 more once in-flight dependencies land · 2 blocked outside the graph. Widest gate: **YT-0410** `web` `review` — **7** open tasks downstream.
...
- **Phase 0 · Foundations** — **42 of 128 settled** (35 verified · 7 awaiting a verifier) · 22 in progress · **251d** left · **35 ready to start** · 13 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **45** open tasks downstream.
...
- `platform` — **25 of 55 settled** (22 verified · 3 awaiting a verifier) · 6 in progress · **93d** left · **14 ready to start** · 4 more once in-flight dependencies land. Widest gate: **YT-0552** `platform` `doing` — **19** open tasks downstream.
...
- `web` — **27 of 59 settled** (13 verified · 14 awaiting a verifier) · 9 in progress · **127d** left · **2 ready to start** · 4 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0055** `web` `doing` — **26** open tasks downstream.
