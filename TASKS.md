...
**293 tasks** — **62 finished (21%)** · 49 in progress · 177 not started · 5 blocked
...
Of the 62 finished: **27 independently verified**, 35 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.

### By phase

| Phase | Done | Review | Doing | Left | Settled |
|---|---|---|---|---|---|
| Phase U · UI first  ◀ NEXT | 6/36 | 18 | 7 | 30d | `██▓▓▓▓▓░░░` 67% |
| Phase −1 · Pilot | 0/13 | 0 | 0 | 36d | `░░░░░░░░░░` 0% |
| Phase 0 · Foundations | 20/124 | 14 | 25 | 258d | `██▓░░░░░░░` 27% |
| Phase 1 · Indonesia MVP | 1/92 | 3 | 17 | 335d | `░░░░░░░░░░` 4% |
| Phase 2 · Depth | 0/22 | 0 | 0 | 240d | `░░░░░░░░░░` 0% |
| Phase 3 · Marketplace & AU | 0/6 | 0 | 0 | 112d | `░░░░░░░░░░` 0% |

- **Phase U · UI first  ◀ NEXT** — **24 of 36 settled** (6 verified · 18 awaiting a verifier) · 7 in progress · **30d** left · **nothing ready to start now** · 2 more once in-flight dependencies land · 2 blocked outside the graph. Widest gate: **YT-0400** `web` `review` — **23** open tasks downstream.
...
- **Phase 0 · Foundations** — **34 of 124 settled** (20 verified · 14 awaiting a verifier) · 25 in progress · **258d** left · **29 ready to start** · 16 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0041** `value` `review` — **85** open tasks downstream.
...
- `economy` — **0 of 8 settled** (0 verified · 0 awaiting a verifier) · 3 in progress · **31d** left · **1 ready to start** · 2 more once in-flight dependencies land. Widest gate: **YT-0048** `economy` `todo` — **25** open tasks downstream.
...
- `legal` — **2 of 9 settled** (1 verified · 1 awaiting a verifier) · 0 in progress · **31d** left · **3 ready to start** · 1 more once in-flight dependencies land · 2 blocked outside the graph. Widest gate: **YT-0012** `legal` `review` — **28** open tasks downstream.
...
- `merchant` — **2 of 17 settled** (1 verified · 1 awaiting a verifier) · 5 in progress · **66d** left · **nothing ready to start now** · 7 more once in-flight dependencies land. Widest gate: **YT-0150** `merchant` `doing` — **18** open tasks downstream.
...
- `web` — **22 of 58 settled** (5 verified · 17 awaiting a verifier) · 14 in progress · **131d** left · **1 ready to start** · 4 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0055** `web` `doing` — **27** open tasks downstream.
