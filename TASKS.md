...
Of the 78 finished: **46 independently verified**, 32 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.
...
| Phase 0 · Foundations | 28/127 | 13 | 22 | 248d | `██▓░░░░░░░` 32% |
| Phase 1 · Indonesia MVP | 5/92 | 4 | 14 | 320d | `█░░░░░░░░░` 10% |
...
- **Phase 0 · Foundations** — **41 of 127 settled** (28 verified · 13 awaiting a verifier) · 22 in progress · **248d** left · **32 ready to start** · 16 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **45** open tasks downstream.
- **Phase 1 · Indonesia MVP** — **9 of 92 settled** (5 verified · 4 awaiting a verifier) · 14 in progress · **320d** left · **5 ready to start** · 13 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0100** `adplatform` `doing` — **68** open tasks downstream.
...
- `adplatform` — **1 of 17 settled** (1 verified · 0 awaiting a verifier) · 1 in progress · **93d** left · **3 ready to start** · 1 more once in-flight dependencies land. Widest gate: **YT-0100** `adplatform` `doing` — **68** open tasks downstream.
...
- `infra` — **6 of 32 settled** (6 verified · 0 awaiting a verifier) · 3 in progress · **86d** left · **12 ready to start** · 3 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **45** open tasks downstream.
- `legal` — **2 of 9 settled** (2 verified · 0 awaiting a verifier) · 1 in progress · **31d** left · **4 ready to start** · 1 blocked outside the graph. Widest gate: **YT-0013** `legal` `todo` — **1** open task downstream.
...
- `platform` — **25 of 55 settled** (18 verified · 7 awaiting a verifier) · 6 in progress · **93d** left · **13 ready to start** · 5 more once in-flight dependencies land. Widest gate: **YT-0552** `platform` `doing` — **19** open tasks downstream.
...
- `value` — **6 of 27 settled** (2 verified · 4 awaiting a verifier) · 6 in progress · **99d** left · **nothing ready to start now** · 8 more once in-flight dependencies land. Widest gate: **YT-0042** `value` `review` — **43** open tasks downstream.
