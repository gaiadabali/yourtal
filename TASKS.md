...
**295 tasks** — **75 finished (25%)** · 41 in progress · 175 not started · 4 blocked

**980 engineer-days left of 1195** — **18% of the estimated effort is settled**, against 25% of the task count. Effort counts every `todo`, `doing` and `blocked` task at its FULL estimate, so a half-finished task bills in full. These are ideal engineer-days for one person — divide by real throughput, not by headcount.

Of the 75 finished: **41 independently verified**, 34 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.

### By phase

| Phase | Done | Review | Doing | Left | Settled |
|---|---|---|---|---|---|
| Phase U · UI first  ◀ NEXT | 13/36 | 13 | 5 | 23d | `████▓▓▓░░░` 72% |
| Phase −1 · Pilot | 0/13 | 0 | 0 | 36d | `░░░░░░░░░░` 0% |
| Phase 0 · Foundations | 24/126 | 17 | 22 | 248d | `██▓░░░░░░░` 33% |
| Phase 1 · Indonesia MVP | 4/92 | 4 | 14 | 322d | `▓░░░░░░░░░` 9% |
| Phase 2 · Depth | 0/22 | 0 | 0 | 240d | `░░░░░░░░░░` 0% |
| Phase 3 · Marketplace & AU | 0/6 | 0 | 0 | 112d | `░░░░░░░░░░` 0% |

- **Phase U · UI first  ◀ NEXT** — **26 of 36 settled** (13 verified · 13 awaiting a verifier) · 5 in progress · **23d** left · **nothing ready to start now** · 2 more once in-flight dependencies land · 2 blocked outside the graph. Widest gate: **YT-0400** `web` `review` — **16** open tasks downstream.
...
- **Phase 0 · Foundations** — **41 of 126 settled** (24 verified · 17 awaiting a verifier) · 22 in progress · **248d** left · **28 ready to start** · 19 more once in-flight dependencies land. Widest gate: **YT-0039** `platform` `review` — **81** open tasks downstream.
- **Phase 1 · Indonesia MVP** — **8 of 92 settled** (4 verified · 4 awaiting a verifier) · 14 in progress · **322d** left · **5 ready to start** · 14 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0100** `adplatform` `doing` — **68** open tasks downstream.
...
| `platform` | 15/54 | 10 | 6 | **10** +7 | 92d | `███▓▓░░░░░` 46% |
| `risk` | 0/15 | 0 | 0 | **4** +2 | 69d | `░░░░░░░░░░` 0% |
| `seo` | 1/5 | 2 | 1 | — | 8d | `██▓▓▓▓░░░░` 60% |
| `store` | 0/10 | 0 | 3 | — +1 | 92d | `░░░░░░░░░░` 0% |
| `value` | 1/27 | 5 | 6 | — +8 | 99d | `▓▓░░░░░░░░` 22% |
| `watch` | 2/8 | 0 | 0 | **1** +1 | 24d | `███░░░░░░░` 25% |
| `web` | 11/59 | 14 | 11 | **1** +5 | 129d | `██▓▓░░░░░░` 42% |
...
- `platform` — **25 of 54 settled** (15 verified · 10 awaiting a verifier) · 6 in progress · **92d** left · **10 ready to start** · 7 more once in-flight dependencies land. Widest gate: **YT-0039** `platform` `review` — **81** open tasks downstream.
...
- `watch` — **2 of 8 settled** (2 verified · 0 awaiting a verifier) · 0 in progress · **24d** left · **1 ready to start** · 1 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0123** `watch` `todo` — **8** open tasks downstream.
- `web` — **25 of 59 settled** (11 verified · 14 awaiting a verifier) · 11 in progress · **129d** left · **1 ready to start** · 5 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0055** `web` `doing` — **26** open tasks downstream.
