...
Of the 62 finished: **29 independently verified**, 33 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.
...
- **Phase 0 · Foundations** — **34 of 124 settled** (20 verified · 14 awaiting a verifier) · 25 in progress · **258d** left · **29 ready to start** · 16 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0041** `value` `review` — **84** open tasks downstream.
...
- `economy` — **0 of 8 settled** (0 verified · 0 awaiting a verifier) · 3 in progress · **31d** left · **1 ready to start** · 2 more once in-flight dependencies land. Widest gate: **YT-0048** `economy` `todo` — **24** open tasks downstream.
...
- `seo` — **1 of 5 settled** (1 verified · 0 awaiting a verifier) · 2 in progress · **15d** left · **1 ready to start**. Widest gate: **YT-0205** `seo` `todo` — **6** open tasks downstream.
...
- `value` — **5 of 27 settled** (0 verified · 5 awaiting a verifier) · 7 in progress · **101d** left · **nothing ready to start now** · 8 more once in-flight dependencies land. Widest gate: **YT-0041** `value` `review` — **84** open tasks downstream.
...
- `web` — **22 of 58 settled** (5 verified · 17 awaiting a verifier) · 14 in progress · **131d** left · **1 ready to start** · 4 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0055** `web` `doing` — **26** open tasks downstream.
