...
Of the 61 finished: **18 independently verified**, 43 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.
...
| Phase 0 · Foundations | 17/124 | 16 | 25 | 259d | `█▓▓░░░░░░░` 27% |
...
- **Phase 0 · Foundations** — **33 of 124 settled** (17 verified · 16 awaiting a verifier) · 25 in progress · **259d** left · **29 ready to start** · 15 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0041** `value` `review` — **86** open tasks downstream.
...
| `platform` | 10/54 | 11 | 8 | **12** +6 | 103d | `██▓▓░░░░░░` 39% |
...
- `platform` — **21 of 54 settled** (10 verified · 11 awaiting a verifier) · 8 in progress · **103d** left · **12 ready to start** · 6 more once in-flight dependencies land. Widest gate: **YT-0039** `platform` `doing` — **75** open tasks downstream.
