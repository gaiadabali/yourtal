...
Of the 44 finished: **1 independently verified**, 43 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.
...
| Phase 1 · Indonesia MVP | 1/90 | 2 | 14 | `░░░░░░░░░░` 3% |
