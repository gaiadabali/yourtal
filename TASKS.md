...
Of the 61 finished: **12 independently verified**, 49 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.
...
| Phase 0 · Foundations | 11/124 | 22 | 25 | 259d | `█▓▓░░░░░░░` 27% |
...
- **Phase 0 · Foundations** — **33 of 124 settled** (11 verified · 22 awaiting a verifier) · 25 in progress · **259d** left · **27 ready to start** · 17 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0041** `value` `review` — **86** open tasks downstream.
...
- `infra` — **6 of 31 settled** (4 verified · 2 awaiting a verifier) · 3 in progress · **86d** left · **11 ready to start** · 3 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **46** open tasks downstream.
...
- `platform` — **21 of 54 settled** (6 verified · 15 awaiting a verifier) · 8 in progress · **103d** left · **9 ready to start** · 9 more once in-flight dependencies land. Widest gate: **YT-0039** `platform` `doing` — **75** open tasks downstream.
