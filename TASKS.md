...
**297 tasks** — **80 finished (27%)** · 41 in progress · 172 not started · 4 blocked

**978 engineer-days left of 1198** — **18% of the estimated effort is settled**, against 27% of the task count. Effort counts every `todo`, `doing` and `blocked` task at its FULL estimate, so a half-finished task bills in full. These are ideal engineer-days for one person — divide by real throughput, not by headcount.

Of the 80 finished: **71 independently verified**, 9 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.

### By phase

| Phase | Done | Review | Doing | Left | Settled |
|---|---|---|---|---|---|
| Phase U · UI first  ◀ NEXT | 25/36 | 3 | 4 | 21d | `███████▓░░` 78% |
| Phase −1 · Pilot | 0/13 | 0 | 0 | 36d | `░░░░░░░░░░` 0% |
| Phase 0 · Foundations | 40/128 | 3 | 22 | 248d | `███░░░░░░░` 34% |
| Phase 1 · Indonesia MVP | 6/92 | 3 | 15 | 321d | `█░░░░░░░░░` 10% |
| Phase 2 · Depth | 0/22 | 0 | 0 | 240d | `░░░░░░░░░░` 0% |
| Phase 3 · Marketplace & AU | 0/6 | 0 | 0 | 112d | `░░░░░░░░░░` 0% |

- **Phase U · UI first  ◀ NEXT** — **28 of 36 settled** (25 verified · 3 awaiting a verifier) · 4 in progress · **21d** left · **1 ready to start** · 2 blocked outside the graph. Widest gate: **YT-0412** `web` `review` — **3** open tasks downstream.
...
- **Phase 0 · Foundations** — **43 of 128 settled** (40 verified · 3 awaiting a verifier) · 22 in progress · **248d** left · **37 ready to start** · 11 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **45** open tasks downstream.
- **Phase 1 · Indonesia MVP** — **9 of 92 settled** (6 verified · 3 awaiting a verifier) · 15 in progress · **321d** left · **4 ready to start** · 14 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0100** `adplatform` `doing` — **67** open tasks downstream.
...
- `web` — **27 of 59 settled** (24 verified · 3 awaiting a verifier) · 10 in progress · **127d** left · **2 ready to start** · 3 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0055** `web` `doing` — **26** open tasks downstream.
