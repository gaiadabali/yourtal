...
**293 tasks** — **62 finished (21%)** · 50 in progress · 176 not started · 5 blocked
...
| Phase 0 · Foundations | 20/124 | 14 | 26 | 258d | `██▓░░░░░░░` 27% |
...
- **Phase 0 · Foundations** — **34 of 124 settled** (20 verified · 14 awaiting a verifier) · 26 in progress · **258d** left · **29 ready to start** · 16 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0041** `value` `review` — **84** open tasks downstream.
