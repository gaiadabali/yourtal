...
**302 tasks** — **81 finished (27%)** · 44 in progress · 173 not started · 4 blocked

**978 engineer-days left of 1204** — **19% of the estimated effort is settled**, against 27% of the task count. Effort counts every `todo`, `doing` and `blocked` task at its FULL estimate, so a half-finished task bills in full. These are ideal engineer-days for one person — divide by real throughput, not by headcount.

Of the 81 finished: **79 independently verified**, 2 awaiting a verifier. A task is only DONE when a session other than the one that did the work has checked it. **The two reviews sampled so far were both wrong**, so that queue is work rather than a formality.
...
| Phase 0 · Foundations | 43/133 | 0 | 24 | 253d | `███░░░░░░░` 32% |
| Phase 1 · Indonesia MVP | 8/92 | 2 | 15 | 316d | `█░░░░░░░░░` 11% |
...
- **Phase 0 · Foundations** — **43 of 133 settled** (43 verified · 0 awaiting a verifier) · 24 in progress · **253d** left · **42 ready to start** · 10 more once in-flight dependencies land. Widest gate: **YT-0529** `infra` `doing` — **45** open tasks downstream.
- **Phase 1 · Indonesia MVP** — **10 of 92 settled** (8 verified · 2 awaiting a verifier) · 15 in progress · **316d** left · **5 ready to start** · 14 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0100** `adplatform` `doing` — **66** open tasks downstream.
...
| `platform` | 27/56 | 0 | 7 | **13** +4 | 89d | `█████░░░░░` 48% |
| `risk` | 0/15 | 0 | 0 | **5** +1 | 69d | `░░░░░░░░░░` 0% |
| `seo` | 1/5 | 2 | 1 | — | 8d | `██▓▓▓▓░░░░` 60% |
| `store` | 0/10 | 0 | 3 | **1** +1 | 92d | `░░░░░░░░░░` 0% |
| `value` | 7/28 | 0 | 5 | **2** +7 | 102d | `███░░░░░░░` 25% |
...
- `platform` — **27 of 56 settled** (27 verified · 0 awaiting a verifier) · 7 in progress · **89d** left · **13 ready to start** · 4 more once in-flight dependencies land. Widest gate: **YT-0552** `platform` `doing` — **18** open tasks downstream.
...
- `value` — **7 of 28 settled** (7 verified · 0 awaiting a verifier) · 5 in progress · **102d** left · **2 ready to start** · 7 more once in-flight dependencies land. Widest gate: **YT-0142** `value` `doing` — **30** open tasks downstream.
