...
**294 tasks** — **74 finished (25%)** · 41 in progress · 174 not started · 5 blocked

**977 engineer-days left of 1190** — **18% of the estimated effort is settled**, against 25% of the task count. Effort counts every `todo`, `doing` and `blocked` task at its FULL estimate, so a half-finished task bills in full. These are ideal engineer-days for one person — divide by real throughput, not by headcount.
...
| Phase 0 · Foundations | 24/125 | 16 | 22 | 245d | `██▓░░░░░░░` 32% |
...
- **Phase 0 · Foundations** — **40 of 125 settled** (24 verified · 16 awaiting a verifier) · 22 in progress · **245d** left · **28 ready to start** · 18 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0039** `platform` `review` — **73** open tasks downstream.
- **Phase 1 · Indonesia MVP** — **8 of 92 settled** (4 verified · 4 awaiting a verifier) · 14 in progress · **322d** left · **5 ready to start** · 14 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0100** `adplatform` `doing` — **57** open tasks downstream.
...
- `adplatform` — **1 of 17 settled** (1 verified · 0 awaiting a verifier) · 1 in progress · **93d** left · **2 ready to start** · 2 more once in-flight dependencies land. Widest gate: **YT-0100** `adplatform` `doing` — **57** open tasks downstream.
...
- `platform` — **25 of 54 settled** (15 verified · 10 awaiting a verifier) · 6 in progress · **92d** left · **10 ready to start** · 7 more once in-flight dependencies land. Widest gate: **YT-0039** `platform` `review` — **73** open tasks downstream.
...
- `web` — **25 of 58 settled** (11 verified · 14 awaiting a verifier) · 11 in progress · **124d** left · **1 ready to start** · 4 more once in-flight dependencies land · 1 blocked outside the graph. Widest gate: **YT-0055** `web` `doing` — **26** open tasks downstream.
