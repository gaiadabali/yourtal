...
export function CampaignCard({ campaign }: CampaignCardProps) {
  ...
  const rewardLabel =
    campaign.scoringRule === "base_plus_accuracy_bonus" ? `Hingga ${formatPoints(campaign.rewardPoints)}` : formatPoints(campaign.rewardPoints);
    ...
    <CampaignCardLayout
      ...
      footerSlot={
        <>
          ...
          {campaign.kind === "quick" ? <Badge variant="outline">Cepat</Badge> : null}
        </>
      }
    />
  );
