...
import { rupiah, toMinorUnits } from "@yourtal/contracts/money";
...
export const alreadyRedeemedVoucherFixture: Voucher = voucherSchema.parse({
  ...
  currency: "IDR",
  faceValueMinor: rupiah(25_000),
  remainingValueMinor: toMinorUnits(0),
...
export const wrongMerchantVoucherFixture: Voucher = voucherSchema.parse({
  ...
  currency: "IDR",
  faceValueMinor: rupiah(60_000),
  remainingValueMinor: rupiah(60_000),
