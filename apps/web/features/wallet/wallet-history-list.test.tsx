...
const entries: WalletHistoryEntry[] = [
  { id: "earn-1", occurredAt: "2026-09-18T09:00:00.000Z", description: "Menyelesaikan video Kopi Kenangan — dapat 2.400 poin", pointsDelta: 2_400 },
  { id: "spend-1", occurredAt: "2026-09-17T09:00:00.000Z", description: "Ditukar 3.000 poin untuk voucher Toko Berkah", pointsDelta: -3_000 },
];
...
describe("WalletHistoryList", () => {
  it("renders each entry's plain-language description, never a transaction code", () => {
    ...
    expect(screen.getByText("Menyelesaikan video Kopi Kenangan — dapat 2.400 poin")).toBeInTheDocument();
