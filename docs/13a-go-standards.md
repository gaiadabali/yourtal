...
| Situation              | Rule                                                                                                                                                                                 |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Passing up             | `fmt.Errorf("charge account %s: %w", id, err)` — wrap with `%w`, add _context the caller lacks_, never the function's own name                                                       |
        ...
        ledger:
          {
            ...
            deny:
              [
                {
                  pkg: "github.com/yourtal/services/voucher",
                  desc: "cross-service import — use the published interface",
                },
              ],
          }
        voucher:
          {
            ...
            deny:
              [
                {
                  pkg: "github.com/yourtal/services/ledger/internal",
                  desc: "internals are not a contract",
                },
              ],
          }
    revive:
