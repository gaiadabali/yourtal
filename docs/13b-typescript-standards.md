...
| Heavy modules | `hls.js`, visx charts and the QR scanner are `next/dynamic` with `ssr: false`, loaded on intent. The 170 KB gz initial-JS budget is a CI gate |
