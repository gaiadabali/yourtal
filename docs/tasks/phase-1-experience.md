...
- [ ] Every page declares its own language: `/au` serves `lang="en-AU"`, `/id` serves `lang="id-ID"`
...
- [ ] Anonymous visitors play the FULL campaign and accrue nothing (decision O-1, as YT-0432 shipped)
