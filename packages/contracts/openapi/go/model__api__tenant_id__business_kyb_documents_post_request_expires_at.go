...
// ApiTenantIdBusinessKybDocumentsPostRequestExpiresAt struct for ApiTenantIdBusinessKybDocumentsPostRequestExpiresAt
type ApiTenantIdBusinessKybDocumentsPostRequestExpiresAt struct {
	TimeTime *time.Time
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *ApiTenantIdBusinessKybDocumentsPostRequestExpiresAt) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(ApiTenantIdBusinessKybDocumentsPostRequestExpiresAt)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ApiTenantIdBusinessKybDocumentsPostRequestExpiresAt) MarshalJSON() ([]byte, error) {
	if src.TimeTime != nil {
...
type NullableApiTenantIdBusinessKybDocumentsPostRequestExpiresAt struct {
	value *ApiTenantIdBusinessKybDocumentsPostRequestExpiresAt
	isSet bool
}

func (v NullableApiTenantIdBusinessKybDocumentsPostRequestExpiresAt) Get() *ApiTenantIdBusinessKybDocumentsPostRequestExpiresAt {
	return v.value
}

func (v *NullableApiTenantIdBusinessKybDocumentsPostRequestExpiresAt) Set(val *ApiTenantIdBusinessKybDocumentsPostRequestExpiresAt) {
	v.value = val
	v.isSet = true
}

func (v NullableApiTenantIdBusinessKybDocumentsPostRequestExpiresAt) IsSet() bool {
	return v.isSet
}

func (v *NullableApiTenantIdBusinessKybDocumentsPostRequestExpiresAt) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiTenantIdBusinessKybDocumentsPostRequestExpiresAt(val *ApiTenantIdBusinessKybDocumentsPostRequestExpiresAt) *NullableApiTenantIdBusinessKybDocumentsPostRequestExpiresAt {
	return &NullableApiTenantIdBusinessKybDocumentsPostRequestExpiresAt{value: val, isSet: true}
}

func (v NullableApiTenantIdBusinessKybDocumentsPostRequestExpiresAt) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiTenantIdBusinessKybDocumentsPostRequestExpiresAt) UnmarshalJSON(src []byte) error {
	v.isSet = true
