...
// BankQuestionRetiredReason struct for BankQuestionRetiredReason
type BankQuestionRetiredReason struct {
	String *string
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *BankQuestionRetiredReason) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(BankQuestionRetiredReason)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src BankQuestionRetiredReason) MarshalJSON() ([]byte, error) {
	if src.String != nil {
...
type NullableBankQuestionRetiredReason struct {
	value *BankQuestionRetiredReason
	isSet bool
}

func (v NullableBankQuestionRetiredReason) Get() *BankQuestionRetiredReason {
	return v.value
}

func (v *NullableBankQuestionRetiredReason) Set(val *BankQuestionRetiredReason) {
	v.value = val
	v.isSet = true
}

func (v NullableBankQuestionRetiredReason) IsSet() bool {
	return v.isSet
}

func (v *NullableBankQuestionRetiredReason) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBankQuestionRetiredReason(val *BankQuestionRetiredReason) *NullableBankQuestionRetiredReason {
	return &NullableBankQuestionRetiredReason{value: val, isSet: true}
}

func (v NullableBankQuestionRetiredReason) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBankQuestionRetiredReason) UnmarshalJSON(src []byte) error {
	v.isSet = true
