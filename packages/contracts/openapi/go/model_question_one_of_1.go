...
func NewQuestionOneOf1(id string, campaignId string, prompt string, timerSeconds int32, answerableAfterSeconds int64, type_ string, correctAnswer bool) *QuestionOneOf1 {
	this := QuestionOneOf1{}
	this.Id = id
